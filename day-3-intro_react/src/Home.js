...
// Assets
import "./App.css";
import altaLogo from "./assets/logo-ALTA@2x.png";
import profilePhoto from "./assets/matthew-hamilton-tNCH0sKSZbA-unsplash.jpg";
    ...
    <div>
          ...
          <div className="row align-items-center">
            <div className="col-lg-8 col-md-12 col-sm-12 col-12">
              <div className="alterra">
                <a href="index.html">
                  <img className="logo-atas" src={altaLogo} alt="altaLogo" />
                </a>
              </div>
            </div>
      ...
      <div className="container h-100">
        <div className="row align-items-center isi-home">
          <div className="col-lg-4 col-md-12 col-sm-12  col-12">
            <img id="foto-profil" src={profilePhoto} alt="foto-profil" />
          </div>
          <div className="col-lg-8 col-md-12 col-sm-12 col-12">
